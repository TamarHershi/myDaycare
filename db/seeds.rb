...
seed_users = [
  {name: "Mellisa", last_name: "Miller", email: "misshershi@gmail.com", room_id: 2, provider: "google", user_type: "t"},
  {name: "Tammy", last_name: "Hershenbum", email: "misstamar@gmail.com", provider: "google", user_type: "p"}
]

seed_parent = [
  {name: "Tammy", last_name: "Hershenabum", email: "misstamar@gmail.com", phone_number1: "425-247-5902", address: "12918 133rd pl NE, Kirkland WA 98034" },
...
seed_children = [
  ...
  address: "12918 133rd pl NE", dob: 4/3/2010, parents_names: "Racheli and Itai", email: "misshershi@gmail.com"},
  ...
  address: "12918 133rd pl NE", dob: 5/6/2011, parents_names: "Boris and Brandon", email: "misshershi@gmail.com"},
  ...
  address: "12918 133rd pl NE", dob: 12/14/2012, parents_names: "Dasi and Eran", email: "misshershi@gmail.com"},
  ...
  address: "12918 133rd pl NE", dob: 8/10/2012, parents_names: "Tammy and Guy", email: "misshershi@gmail.com"},
  {name: "Tom",last_name: "Mor", gender: "boy", room_id: 2, parent1_number: "425-247-5902",parent_id: parent2.id,
  parent2_number: "425-247-5901", medications_sensitivity: "none", city: "Woodinvlle", tuition: 1450,
  address: "12918 133rd pl NE", dob: 1/4/2012, parents_names: "Noa and Danny", email: "misshershi@gmail.com"},
  {name: "Mia",last_name: "Kadmon", gender: "girl", room_id: 2, parent1_number: "425-247-5902",parent_id: parent2.id,
  parent2_number: "425-247-5901", medications_sensitivity: "none", city: "Seattle", tuition: 1450,
  address: "12918 133rd pl NE", dob: 10/17/2012, parents_names: "Rotem and Yoav", email: "misshershi@gmail.com"},
  {name: "Rona",last_name: "Kadmon", gender: "girl", room_id: 1, parent1_number: "425-247-5902",parent_id: parent.id,
  parent2_number: "425-247-5901", medications_sensitivity: "none", city: "Seattle", tuition: 1450,
  address: "12918 133rd pl NE", dob: 11/20/2014, parents_names: "Tammy and Guy", email: "misshershi@gmail.com"},
  {name: "Elinor",last_name: "Kadmon", gender: "girl", room_id: 2, parent1_number: "425-247-5902",parent_id: parent2.id,
  parent2_number: "425-247-5901", medications_sensitivity: "none", city: "Seattle", tuition: 1450,
  address: "12918 133rd pl NE", dob: 3/4/2012, parents_names: "Lital and Gabi", email: "misshershi@gmail.com"},
  {name: "Tagel",last_name: "Kadmon", gender: "girl", room_id: 2, parent1_number: "425-247-5902",parent_id: parent2.id,
  parent2_number: "425-247-5901", medications_sensitivity: "none", city: "Seattle", tuition: 1450,
  address: "12918 133rd pl NE", dob: 8/11/2012, parents_names: "Adi and Heidad", email: "misshershi@gmail.com"}
]
