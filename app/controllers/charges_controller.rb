...
def create
  ...
  Charge.create(:child_id => @child.id, :date => DateTime.now.strftime('%Y-%m'), :amount => @amount, :authenticity_token => params[:authenticity_token], :stripeToken => params[:stripeToken])
